...
#define  LOG_TRACE   std::clog << BOOST_CURRENT_FUNCTION << ": "
#define  LOG_DEBUG   std::clog << BOOST_CURRENT_FUNCTION << ": "
#define  LOG_INFO    std::clog  << ": "
#define  LOG_WARNING std::cerr << BOOST_CURRENT_FUNCTION << ": "
#define  LOG_ERROR   std::cerr << BOOST_CURRENT_FUNCTION << ": "
#define  LOG_FATAL   std::cerr << BOOST_CURRENT_FUNCTION << ": "
