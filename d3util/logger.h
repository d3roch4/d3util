...
//#define  LOG_TRACE   std::clog << std::endl << BOOST_CURRENT_FUNCTION << ": " <<
//#define  LOG_DEBUG   std::clog << std::endl << BOOST_CURRENT_FUNCTION << ": " <<
//#define  LOG_INFO    std::clog << std::endl << ": "                           <<
//#define  LOG_WARNING std::cerr << std::endl << BOOST_CURRENT_FUNCTION << ": " <<
//#define  LOG_ERROR   std::cerr << std::endl << BOOST_CURRENT_FUNCTION << ": " <<
//#define  LOG_FATAL   std::cerr << std::endl << BOOST_CURRENT_FUNCTION << ": " <<
